                    ...
                    <div class="wrapper">
                        <div class="blog-items">
                            ...
                            <div class="main-heading">
                                <h2>Before starting a building construction, the owner sure has necessary
                                    permits.
                                </h2>
                            </div>
                            <div class="inner-section">
                                <p>Construction planning is a fundamental and challenging activity in the
                                    management
                                    and execution of construction projects. It involves the choice of
                                    technology,
                                    the definition of work tasks, the estimation of the required resources and
                                    durations for individual tasks, and the identification of any interactions
                                    among
                                    the different work tasks.</p>
                            </div>
                            <div class="main-btn">
                        ...
                        <div class="blog-items">
                            <div class="main-img">
                                <img class="img-fluid" src="./assets/img/blog/blog-12.png" alt="">
                            </div>
                            <div class="admin-intro">
                                <div class="name">
                                    <span><i class="fa-solid fa-user"></i></span>
                            ...
                            <div class="main-heading">
                                <h2>Human shelters were at first very simple and perhaps lasted only a few days
                                    or months.
                                </h2>
                            </div>
                            <div class="inner-section">
                        ...
                        <div class="blog-items">
                            <div class="main-img">
                                <img class="img-fluid" src="./assets/img/blog/blog-9.png" alt="">
                            </div>
                            <div class="admin-intro">
                                <div class="name">
                                    <span><i class="fa-solid fa-user"></i></span>
                            ...
                            <div class="main-heading">
                                <h2>he history of building is marked by a number of trends. One is the
                    ...
                    <div class="widget-six">
                        <div class="wrapper">
                            ...
                            <div class="blog-inner-items">
                                <div class="item">
                                    <div class="img-file">
                                        <img class="img-fluid" src="./assets/img/blog/blog-11.png" alt="">
                                    </div>
                                    <div class="text-file">
                                        <a href="blog-details.html">
